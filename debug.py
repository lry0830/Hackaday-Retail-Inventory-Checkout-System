...
yolo = yolov5(yolo_type='yolov5',weights='D:\\UTAR\\FYP\\Hackaday\\POS\\weights\\last_3.onnx')

# GUI Setup
cv2.namedWindow("POS v1", cv2.WINDOW_NORMAL)
cv2.setWindowProperty("POS v1", cv2.WINDOW_NORMAL, cv2.WINDOW_NORMAL)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        bg = cv2.imread("D:\\UTAR\\FYP\\Hackaday\\POS\\images\\bg.jpg")
        ...
        if YOLO_run:
            ...
            if (len(shoplist) > 0):
                ...
                if k == 0xFF & ord("p"):
                    ...
                    if yn:
                        pay = cv2.imread(r'D:\UTAR\FYP\Hackaday\POS\images\Payment.jpg')
