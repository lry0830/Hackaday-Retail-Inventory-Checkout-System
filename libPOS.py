...
class desktop:
    def __init__(self, bg_path, click_bg_path):
        self.bg = "D:\\UTAR\\FYP\\Hackaday\\POS\\images\\bg.jpg"
        self.click_bg = "D:\\UTAR\\FYP\\Hackaday\\POS\\images\\bgClick.jpg"
    ...
    def display(self, camImg, txtStatus=None, itemList=None):
        ...
        if (itemList is not None):
            ...
            total = cv2.imread("D:\\UTAR\\FYP\\Hackaday\\POS\\images\\total.jpg")
